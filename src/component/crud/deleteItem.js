    ...
    return (
        <div className="card">
            <div className="card-body">
                ...
                <Link to={`/crud/medicines/${props.medicine.id}/edit`} className="btn btn-primary float-right">Edit</Link>
                <Link to={`/crud/medicines/${props.medicine.id}`} className="btn btn-info float-right">View</Link>
